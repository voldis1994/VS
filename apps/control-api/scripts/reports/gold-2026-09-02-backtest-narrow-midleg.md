# Gold backtest — 2026-09-02 (1m) · narrow-midleg

Source: **Yahoo Finance GC=F** (public). Lot **0.1**. Spread **0.5**.
Mode: **narrow mid-leg CONTINUATION only (bias + not climax + mid reason)**.
...
| £ left on table (unnecessary) | **£11.17** |

## Unnecessary blocks

Shadow = ja būtu iegujuši ar to pašu exit smadzenēm. Unnecessary = shadow peļņa > £0.05 un MFE ≥ 0.8pt.

- **8×** wait · need 2 green 1m (momentum)
- **6×** wait · spike 1m — need next candle confirm
...
- **candle**: 88 blocked · **23** unnecessary
- **against_move**: 20 blocked · **6** unnecessary
- **post_exit**: 7 blocked · **4** unnecessary
...
Full JSON: `scripts/reports/gold-2026-09-02-backtest-narrow-midleg.json`
