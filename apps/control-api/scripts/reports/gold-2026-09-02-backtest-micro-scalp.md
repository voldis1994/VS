# Gold backtest — 2026-09-02 (1m) · micro-scalp

Source: **Yahoo Finance GC=F** (public). Lot **0.1**. Spread **0.5**.
Mode: **live + micro-SCALP (NONE 1m impulse/micro-swing, SCALP exits)**.
...
Full JSON: `scripts/reports/gold-2026-09-02-backtest-micro-scalp.json`
