# Gold backtest — 2026-09-02 (1m) · micro-strict

Source: **Yahoo Finance GC=F** (public). Lot **0.1**. Spread **0.5**.
Mode: **live + micro-chop (strict filter, SCALP book)**.
...
Full JSON: `scripts/reports/gold-2026-09-02-backtest-micro-strict.json`
