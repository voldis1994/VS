# Gold backtest — 2026-09-02 (1m) · micro-raw-long

Source: **Yahoo Finance GC=F** (public). Lot **0.1**. Spread **0.5**.
Mode: **live + micro-chop (raw filter, LONG book)**.
...
Full JSON: `scripts/reports/gold-2026-09-02-backtest-micro-raw-long.json`
