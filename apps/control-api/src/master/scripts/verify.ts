  ...
  // 7) Recovery + MT4 + filters modules exist
  {
    ...
    const multiEpicCycleApi =
      ...
      readFileSync(join(root, 'src/master/positionManager.ts'), 'utf8').includes(
        'epicsMatch(pos.epic, quote.epic)'
      );
