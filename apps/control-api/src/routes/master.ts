...
async function refresh(){
  try{
    ...
    cards.innerHTML=[
      ...
      card('UTC day roll',s.utc_day_roll_deferred?'DEFERRED':(s.capital_account_proven===false?'UNPROVEN':'ok'),s.capital_account_proven===false?'bad':(s.utc_day_roll_deferred?'warn':'ok')),
