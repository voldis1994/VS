...
describe('instrumentScale', () => {
  ...
  it('recentImpulse detects dump on EURUSD-sized moves', () => {
    const bars: CapitalPriceCandle[] = [];
    for (let i = 0; i < 22; i++) bars.push(candle(1.085, 1.0852, 1.0848, 1.085));
    for (let i = 0; i < 5; i++) {
      const o = 1.085 - i * 0.0002;
      bars.push(candle(o, o + 0.00005, o - 0.00025, o - 0.0002));
    }
