 ...
 */
export type OperationalBlock = 'FEED_UNAVAILABLE' | 'INSUFFICIENT_DATA' | 'NO_SETUP' | 'DATA_QUALITY_BLOCK' | 'EMERGENCY_SL_CEILING' | 'BROKER_REJECT' | 'RECONCILIATION_BLOCK';
...
export type OrderLifecycleState = 'SETUP' | 'ENTRY_PENDING' | 'SUBMITTED' | 'ACKNOWLEDGED' | 'PARTIALLY_FILLED' | 'FILLED' | 'PROTECTED' | 'MANAGING' | 'EXIT_PENDING' | 'CLOSED' | 'REJECTED' | 'CANCELLED' | 'ERROR';
